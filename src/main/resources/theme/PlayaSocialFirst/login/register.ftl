                        ...
                        <div class="modal-body">
                            <form action="${url.registrationAction}" method="post" onchange="onchangef()" onsubmit="onsubmitf();">
                                <section>
                                    ...
                                    <div class="form-group-request">
                                        <div style="width: 100%">${msg("email")}</div>
                                                            ...
                                                            <clr-alert-item _ngcontent-c1="" class="alert-item">
                                                                ...
                                                                <span _ngcontent-c1="" class="alert-text">
                                                                    ...
                                                                    <#if message.summary = msg("emailExistsMessage")>
                                                                        ${msg("lblAuthText")} <a style="display: inline; padding: 0;" tabindex="5" href="${url.loginResetCredentialsUrl}">${msg("doForgotPassword")}</a> ${msg("lblResetCurrentPassword")}
                                                                    </#if>
                                                                </span>
                                                            </clr-alert-item>
                                                        </div>
